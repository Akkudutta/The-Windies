        ...
        df = pd.DataFrame(
            {
                ...
                'day': [15.492],
                'wind_speed': [109.633],
                'atmospheric_temperature': [14.687],
                'shaft_temperature': [36.974],
                'blades_angle': [9.81],
                'gearbox_temperature': [58.129],
                'engine_temperature': [26.814],
                'motor_torque': [1737.799],
                'atmospheric_pressure': [104989.658],
                'area_temperature': [16.383],
                'windmill_body_temperature': [112.179],
                'wind_direction': [277.227],
                'resistance': [1740.587],
                'rotor_torque': [35.114],
                'turbine_status': [7.039],
                'cloud_level': [2.504],
                'blade_length': [4.682],
                'blade_breadth': [1],
                'windmill_height': [31.079]
            }
        )
